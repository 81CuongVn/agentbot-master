...
module.exports = {
    welcome: async function welcome(username, discrim, avatarURL, membersize){
        ...
        Canvas.registerFont(__dirname + '/assets/font/Cadena.ttf', { family: 'Cadena', weight: "regular", style: "normal" })
        //create canvas
        const canvas = Canvas.createCanvas(700, 250);
        const ctx = canvas.getContext('2d');
    
        const background = await Canvas.loadImage(__dirname + '/assets/images/moscow.png');
    ...
    Canvas.registerFont(__dirname + '/assets/font/regular-font.ttf', {
        family: 'Manrope',
        weight: 'regular',
        style: 'normal'
    });

    Canvas.registerFont(__dirname + '/assets/font/bold-font.ttf', {
        family: 'Manrope',
        weight: 'bold',
        style: 'normal'
    });
